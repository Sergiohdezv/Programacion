...
public class Sistema_Gestion {
    ...
    private Map<String, ArrayList<Estudiante>> estudiantesPorCiudad;
    private Queue<Estudiante> colaPorOrden;

    public Sistema_Gestion() {
        estudiantes = new ArrayList<>();
        ciudades = new HashSet<>();
        estudiantesPorCiudad = new HashMap<>();
        colaPorOrden = new LinkedList<>();
    }

    public void agregarEstudiantes(String ruta) {
    ...
    public void generarCola() {
        ...
        colaPorOrden.addAll(estudiantes);
    }

    public void atenderEstudiantes() {

        while (!colaPorOrden.isEmpty()) {

            Estudiante atendido = colaPorOrden.poll();
