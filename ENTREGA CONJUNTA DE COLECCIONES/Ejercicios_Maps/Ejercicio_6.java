...
public class Ejercicio_6 {
    public static void agregarEstudianteYNota(Map<String, List<Integer>> mapa, String nombre, List<Integer> notas){
        mapa.put(nombre, notas);
    }

    public static void mostrarPromedio(Map<String,List<Integer>> mapa){
